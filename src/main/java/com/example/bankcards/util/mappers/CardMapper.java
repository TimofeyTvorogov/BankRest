...
public interface CardMapper {
    ...
    @Mapping(target = "maskedCardNum", source = "cardNum", qualifiedByName = "mapToMaskedNum")
    @Mapping(target = "activeTill", source = "activeTill")
    ...
    @Named("mapToMaskedNumFromEntity")
    default String mapCardNumFromEntity(Card card) {
        var cardNum = card.getCardNum();
        return mapCardNum(cardNum);
    }
